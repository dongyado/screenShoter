...
public class ScreenShoter  extends JFrame{
	...
	public  ScreenShoter(){
		...
		setLocation( 
				(SShoterConfig.SCREEN_SIZE.width - SShoterConfig.FRAME_SIZE.width) / 2,
		...
		buttonEnd.registerKeyboardAction(
				 new ButtonEndActionListener(), KeyStroke.getKeyStroke(KeyEvent.VK_Q, KeyEvent.CTRL_MASK), JComponent.WHEN_IN_FOCUSED_WINDOW);  
	...
	public class ButtonStartActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			try {
				...
				Thread.sleep(100);
				robot = new Robot();
				screenimg = robot.createScreenCapture( new Rectangle(  0, 0, (int)SShoterConfig.SCREEN_SIZE.getWidth(), (int)SShoterConfig.SCREEN_SIZE.getHeight() ));
